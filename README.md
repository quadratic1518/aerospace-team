...
**Author:** [RAAVI PRANEETH REDDY](https://github.com/quadratic1518/aerospace-team)
**Creator:** RAAVI PRANEETH REDDY
**Generated by:** Skills Factory Engine v1.1

## Research Paper

**Author:** RAAVI PRANEETH REDDY · **Institution:** SRM Institute of Science and Technology

| Format | View |
|--------|------|
| **Markdown (recommended — opens in browser, no download)** | [RESEARCH_PAPER.md on GitHub](https://github.com/quadratic1518/aerospace-team/blob/main/RESEARCH_PAPER.md) |
| **Web page (optional)** | Enable GitHub Pages: repo **Settings → Pages → Source: `/docs`** → then visit [quadratic1518.github.io/aerospace-team](https://quadratic1518.github.io/aerospace-team/) |
| Word (.docx) | Download only — GitHub cannot preview `.docx` inline |
